...
export default function Affiliate() {
  return (
    <div className="affiliate-page-cover">
      ...
      <div className="mobile-affiliate-cover">
        <div className="mobile-affiliate-main-img1"></div>
        <div className="mobile-affiliate-main-img2">
          <div className="mobile-affiliate-main-img3">
            <div className="inner-affiliate-text">
              Commission ready everyday
              <br />
              <span className="away"> $1000 </span>
              Just a referral away
            </div>
            <button className="refer">Create Referral Code Now</button>
          </div>
        </div>
      </div>
      ...
      <div className="affiliate-page-display-cover-inner">
        ...
        <div className="affiliate-flex2">
          <div className="affiliate-flex2-1">
            ...
            <h4>
              ...
              and set sail on a new chapter in your wealth journey immediately!
            </h4>
          ...
          <div className="affiliate-flex2-2">
            ...
            <h4>
              If you got your own plan. you can set up a casino website with
              your own domain, design style and theme. If you are capable to
              invite players and their wager amount reaches a billion dollars
              and above, you will be able to get your own customized casino!{" "}
              <br />
        ...
        <div className="affiliate-main-heading2">
          ...
          <h4>
            ...
            addition to commission. Click "Create Referral Code Now" and set
            sail on a new chapter on your journey of wealth immediately!
          </h4>
        ...
        <div className="affiliate-flex4">
          <div className="affiliate-flex4-bg">
            ...
            <h4>
              ...
              access to a large audience. Please feel free to contact our
              manager by Telegram. We're happy to discuss individual terms of
              the affiliate program tailored to you.
            </h4>
          </div>
        </div>

        <div className="mobile-affiliate-reward">
          <div className="reward-header">Rewards sent out till date</div>
          <div className="reward-header-display">
            <div className="reward-header-page">
              <div className="reward-header-page-text">
                USD rewards sent out till date
              </div>
              <div className="reward-header-page-number">
                <div className="value">57276.5</div>
                <div className="type">USD</div>
              </div>
            </div>

            <div className="reward-header-page2">
              <div className="reward-header-page-text2">
                Commission sent out till date
              </div>
              <div className="reward-header-page-number">
                <div className="value">6745.5</div>
                <div className="type">USD</div>
              </div>
            </div>
          </div>
