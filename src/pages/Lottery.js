...
import lotteryBg from "../images/images/lottery bg1.png";
import lotteryBg1 from "../images/images/lottery bg.png";
import lottery1 from "../images/images/lottery1 img1.png";
import lottery2 from "../images/images/lottery1 img2.png";
...
import displayBg from "../images/images/lottery-display-bg.png";
import displayBg1 from "../images/images/lottery-display-bg1.png";
import displayBg2 from "../images/images/lottery-display-bg2.png";
import displayImg1 from "../images/images/lottery-display-img1.png";
import displayImg2 from "../images/images/lottery-display-img2.png";
import displayImg3 from "../images/images/lottery-display-img3.png";
import gold from "../images/images/gold arrow forward.png";
import footer from "../images/images/lottery footer img.png";
import { NavLink, Outlet } from "react-router-dom";
import Footer from "./FooterPage";

export default function Lottery() {
  return (
    <div className="lottery-page-cover-page">
      <div className="lottery-page-cover-inner">
        <div className="lottery1">
          ...
          <div className="lottery1-img2">
            ...
            <div className="lottery-top-text">
              <div className="time-lottery">
                <div className="time-lottery-text">Next Draw in</div>
                <div className="time-lottery-count">
                  <span>15h</span>:<span>28m</span>:<span>17s</span>
                </div>
              </div>
              <button className="lottery-btn">
                <div className="lottery-btn-inner">
                  <div className="lottery-btn-inner-text">
                    <div className="lottery-btn-inner-text-buy">Buy Ticket</div>
                    <div className="lottery-btn-inner-text-ticket">
                      1 ticket for $0.1
                    </div>
                  </div>
                </div>
              ...
              <h3>
                Don't miss your chance! <span>26382</span> tickets have been
                sold today!
              </h3>
            </div>
          </div>
